...
*/if (irq & MCP2515::CANINTF_RX0IF){
    ...
    if (canMsg.can_id == 0x80217FFC) 
    {
      ...
      if (canMsg.data[3] == 0xd2) {
        ...
        // 16:31:54.673 -> 80217FFC 217FFC 8 7 EB 40 D2 F0 58 0 0 
        Serial.print("\n Lights off\n");
        Serial.print("\n---------------------------------------------\n");
      }

      if (canMsg.data[3] == 0xd4) {
        // 16:32:26.959 -> 80217FFC 217FFC 8 7 EB 40 D4 F0 58 0 0 
        Serial.print("\n Lights: park on \n");
        Serial.print("\n---------------------------------------------\n");
      }

      if (canMsg.data[3] == 0xd8) {
        // 16:32:53.304 -> 80217FFC 217FFC 8 7 6B 40 D8 F0 58 0 0 
        Serial.print("\n Lights: low beams \n");
        Serial.print("\n---------------------------------------------\n");
      }
    }
    */
    ...
    // no effect when door is closed 
    if (canMsg.can_id == 0x814034A2) 
    {
      Serial.print("\n---------------------------------------------\n");
    
      if (canMsg.data[3] == 0xd2) {
        // 17:57:00.160 -> 814034A2 14034A2 8 0 5B 40 4 89 23 4 0
        // 16:29:27.298 -> 80217FFC 217FFC 8 5 6B 40 D2 F0 58 0 0 
        // 16:31:54.673 -> 80217FFC 217FFC 8 7 EB 40 D2 F0 58 0 0 
        Serial.print("\n Lights off\n");
        Serial.print("\n---------------------------------------------\n");
